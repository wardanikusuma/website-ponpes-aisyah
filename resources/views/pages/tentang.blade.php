...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-20 w-full">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <p class="text-lg md:text-2xl text-purple-100 font-medium leading-relaxed drop-shadow-md mb-4">
                    Mengenal lebih dekat Pondok Pesantren Modern Aisyah Samawa, pusat keunggulan pendidikan muslimah di
                    Sumbawa.
                </p>
            </div>
        </div>
    ...
    <section id="profil" class="py-28 bg-white relative overflow-hidden scroll-mt-24">
        <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-20 items-center">
            <div>
                ...
                <h3 class="text-4xl font-black text-gray-900 mb-8 leading-tight">Dedikasi untuk <br><span
                        class="text-purple-800 tracking-tighter italic">Pendidikan Muslimah</span></h3>
                <div class="space-y-6 text-gray-600 text-lg leading-relaxed font-medium">
                    <p>Pondok Pesantren Modern Aisyah Samawa adalah lembaga pendidikan Islam yang berkomitmen mencetak
                        generasi muslimah unggul. Berlokasi di jantung Sumbawa Besar, kami memadukan tradisi keislaman yang
                        kuat dengan kurikulum modern yang dinamis.</p>
                    <p>Kami percaya bahwa setiap santriwati memiliki potensi besar untuk menjadi pemimpin, ilmuwan, dan
                        pendidik di masa depan dengan fondasi akhlak yang kokoh.</p>
                </div>
            </div>

            <div class="relative group">
                <div
                    class="absolute inset-0 bg-gradient-to-tr from-purple-600 to-fuchsia-600 rounded-[2rem] rotate-3 scale-105 opacity-20 transition-transform duration-500 group-hover:rotate-6">
                </div>
                <img src="https://images.unsplash.com/photo-1541829070764-84a7d30dee93?auto=format&fit=crop&q=80&w=800"
                    alt="Profil Pondok" class="relative rounded-[2rem] shadow-2xl w-full object-cover aspect-[4/3]">
            </div>
        </div>
    </section>
    ...
    {{-- 2. VISI & MISI --}}
    <section id="visi"
        class="py-24 md:py-28 bg-[#fbf9ff] border-y border-purple-100 scroll-mt-24 relative overflow-hidden">
        ...
        <div
            class="absolute top-48 left-8 w-28 h-28 opacity-25 bg-[radial-gradient(circle,#a855f7_2px,transparent_2px)] bg-[length:16px_16px]">
        </div>
        <div
            class="absolute bottom-36 right-10 w-28 h-28 opacity-20 bg-[radial-gradient(circle,#c026d3_2px,transparent_2px)] bg-[length:16px_16px]">
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
            ...
            <div class="max-w-5xl mx-auto mb-24 text-center mission-reveal">
                <span
                    class="inline-flex px-5 py-2 rounded-full bg-purple-100/80 text-purple-700 text-xs font-black tracking-[0.2em] uppercase mb-5">
                    Arah dan Tujuan Kami
                </span>
                <h2 class="text-4xl md:text-6xl font-black text-[#160735] tracking-tighter mb-8">
                    VISI <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-fuchsia-500">KAMI</span>
                </h2>
                <div
                    class="group relative rounded-[2rem] bg-gradient-to-r from-[#2d0a64] via-purple-800 to-fuchsia-700 p-[1px] shadow-xl shadow-purple-200/70 overflow-hidden">
                    <div class="relative rounded-[calc(2rem-1px)] bg-white/95 px-8 py-10 md:px-16 md:py-12 overflow-hidden">
                        ...
                        <p class="relative text-xl md:text-3xl font-bold leading-relaxed text-[#2b1455] tracking-tight">
                            “Menjadi lembaga pendidikan muslimah terkemuka yang melahirkan generasi berakhlak mulia, cerdas
            ...
            <div class="text-center max-w-3xl mx-auto mb-16 mission-reveal">
                <span
                    class="inline-flex px-5 py-2 rounded-full bg-fuchsia-100/70 text-purple-700 text-xs font-black tracking-[0.16em] uppercase mb-5">
            ...
            @php
                $missions = [
                    [
                        ...
                        'description' =>
                            'Menyelenggarakan sistem pendidikan yang berkualitas dalam frame islami sesuai dengan manhaj Ahlus Sunnah Wal Jama’ah.',
                        'icon' => 'book',
                    ],
                    [
                        'number' => '02',
                        ...
                        'description' =>
                            'Mengupayakan secara maksimal program Tahfidz Al-Qur’an & Sains sebagai brand keunggulan pesantren.',
                        'icon' => 'quran',
                    ],
                    [
                        'number' => '03',
                        'title' => 'Budaya Bangsa',
                        'description' =>
                            'Menumbuhkan pemahaman yang mendalam tentang dasar perilaku islami serta pelestarian budaya bangsa.',
                        'icon' => 'people',
                    ],
                    [
                        'number' => '04',
                        ...
                        'description' =>
                            'Melaksanakan pendidikan dan pembelajaran secara efektif dan menyenangkan dengan mengacu pada moralitas dan akhlakul karimah.',
                        'icon' => 'graduate',
                    ],
                    [
                        'number' => '05',
                        ...
                        'description' =>
                            'Menyelenggarakan pendidikan yang kreatif, inovatif, dan variatif dalam nuansa lingkungan pondok pesantren yang asri.',
                        'icon' => 'idea',
                    ],
                ];
            @endphp
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-x-6 gap-y-20 lg:gap-y-16 max-w-6xl mx-auto pt-4">
                @foreach ($missions as $index => $mission)
                    <article
                        class="mission-card mission-reveal group relative lg:col-span-2 {{ $index === 3 ? 'lg:col-start-2' : '' }} bg-white rounded-[1.75rem] px-7 pt-16 pb-10 min-h-[280px] text-center border border-purple-100 shadow-[0_18px_45px_-18px_rgba(88,28,135,0.25)] hover:-translate-y-3 hover:shadow-[0_28px_55px_-18px_rgba(126,34,206,0.38)] transition-all duration-500"
                        style="--mission-delay: {{ $index * 110 }}ms">
                        <div
                            class="absolute top-6 left-6 w-12 h-12 rounded-xl bg-gradient-to-br from-purple-50 to-fuchsia-100 text-purple-800 flex items-center justify-center text-lg font-black">
                            {{ $mission['number'] }}
                        </div>

                        <div
                            class="mission-icon absolute -top-11 left-1/2 -translate-x-1/2 w-[88px] h-[88px] rounded-full p-2 bg-white shadow-xl shadow-purple-200/70 border border-purple-100">
                            <div
                                class="w-full h-full rounded-full bg-gradient-to-br from-fuchsia-500 via-purple-600 to-violet-800 text-white flex items-center justify-center ring-1 ring-fuchsia-300 ring-offset-4 ring-offset-purple-50">
                                ...
                                @elseif ($mission['icon'] === 'quran')
                                    <svg class="w-9 h-9" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.7"
                                            d="M4 5l8 4 8-4-8-3-8 3zM4 10l8 4 8-4M4 15l8 4 8-4" />
                                    </svg>
                                @elseif ($mission['icon'] === 'people')
                                    <svg class="w-9 h-9" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.7"
                                            d="M16 20v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2M9 10a4 4 0 100-8 4 4 0 000 8zM22 20v-2a4 4 0 00-3-3.87M16 2.13a4 4 0 010 7.75" />
                                    </svg>
                                ...
                                @else
                                    <svg class="w-9 h-9" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.7"
                                            d="M9 18h6M10 22h4M8.2 14.5A7 7 0 1115.8 14.5 5 5 0 0014 18h-4a5 5 0 00-1.8-3.5zM12 2v2M4.9 4.9l1.4 1.4M19.1 4.9l-1.4 1.4" />
                                    </svg>
                                @endif
                            </div>
                        </div>
                        ...
                        <div
                            class="w-12 h-0.5 bg-gradient-to-r from-purple-500 to-fuchsia-400 mx-auto mt-6 group-hover:w-24 transition-all duration-500">
                        </div>
                    </article>
                @endforeach
            </div>
    ...
    <section id="akreditasi"
        class="relative py-28 bg-gradient-to-br from-slate-950 via-slate-900 to-purple-950 overflow-hidden scroll-mt-24">

        {{-- Background Blur --}}
        <div class="absolute -top-40 -left-40 w-96 h-96 bg-fuchsia-600/20 rounded-full blur-3xl">
        </div>

        <div class="absolute -bottom-40 -right-40 w-[500px] h-[500px] bg-purple-700/20 rounded-full blur-3xl">
        </div>
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-6">
            ...
            <div class="text-center mb-16">
                ...
                <span class="uppercase tracking-[0.4em] text-fuchsia-400 text-sm font-black">
                    Kualitas & Legalitas
                </span>

                <h2 class="text-5xl font-black text-white mt-5">
                    Akreditasi <span class="text-fuchsia-400">Unggul</span>
                </h2>

                <p class="text-gray-400 mt-5 text-lg max-w-2xl mx-auto">
                    Pondok Pesantren Modern Aisyah Samawa berkomitmen
                    memberikan pendidikan Islam modern yang berkualitas
                    dengan legalitas resmi dari Kementerian Agama RI.
                </p>

            </div>

            {{-- Card Besar --}}
            <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[40px] p-12">
                ...
                <div class="grid lg:grid-cols-2 gap-14 items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-300 leading-8 text-lg mb-8">
                            ...
                            Akreditasi ini menjadi bukti bahwa sistem pendidikan,
                            kurikulum, tenaga pendidik, serta fasilitas Pondok
                            Pesantren Modern Aisyah Samawa telah memenuhi
    ...
    <section id="struktur" class="py-28 bg-white scroll-mt-24">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-20">
                ...
                <h3 class="text-4xl md:text-5xl font-black text-gray-900 tracking-tighter">Struktur <span
                        class="text-fuchsia-600">Organisasi</span></h3>
            </div>

            <div
                class="relative p-8 md:p-16 bg-slate-50 rounded-[4rem] border border-slate-200 overflow-hidden shadow-inner">
                <div
                    class="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-purple-100/20 to-transparent opacity-50">
                </div>
                ...
                <div class="mt-12 grid grid-cols-2 md:grid-cols-4 gap-8 relative z-10 text-center">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-purple-600 font-bold text-sm uppercase tracking-widest mt-2">Kurikulum & Kesiswaan
                        </p>
                    </div>
                    <div class="p-6">
    ...
    <section id="fasilitas" class="py-28 bg-slate-50 border-t border-slate-200 scroll-mt-24">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-20">
                ...
                <h3 class="text-4xl md:text-5xl font-black text-gray-900 tracking-tighter">Fasilitas <span
                        class="text-purple-700">Kami</span></h3>
                <p class="mt-6 text-gray-500 text-lg font-medium max-w-2xl mx-auto leading-relaxed">
                    Kami menyediakan fasilitas modern dan nyaman untuk mendukung proses belajar dan kehidupan santriwati
                    sehari-hari.
                </p>
            </div>
                ...
                <div class="group relative rounded-[2rem] overflow-hidden aspect-[4/3] shadow-xl">
                    ...
                    <div class="absolute bottom-0 left-0 p-8">
                        <div class="w-10 h-10 bg-fuchsia-600 rounded-xl flex items-center justify-center mb-3">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 3v1m0 16v1m8.66-13l-.87.5M4.21 17.5l-.87.5M20.66 17.5l-.87-.5M4.21 6.5l-.87-.5M21 12h1M2 12h1" />
                            </svg>
                        </div>
