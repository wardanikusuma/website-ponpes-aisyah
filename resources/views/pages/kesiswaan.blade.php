    ...
    <section id="ekstrakurikuler" class="py-28 bg-white scroll-mt-24">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-20">
                ...
                <h2 class="text-4xl font-black text-gray-900 tracking-tight italic">Ekstra<span
                        class="text-fuchsia-600">Kurikuler</span></h2>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                @forelse ($eskul as $e)
                    <div
                        ...
                        <div
                            class="w-20 h-20 mx-auto bg-white rounded-2xl flex items-center justify-center text-4xl mb-6 grayscale group-hover:grayscale-0 group-hover:scale-110 transition-all duration-500 overflow-hidden border border-slate-100">
                            @if ($e->gambar)
